...
\uncover<2->{I didn't mention \includegraphics[height=\baselineskip]{histbook-logo.pdf} in this talk because I'm rethinking how histogramming ought to be done, a way to enable projects with different strengths to share histogram objects in memory. This gets generally to common protocols and code reuse, which many of us in Scikit-HEP are considering together.}

\vspace{0.25 cm}
\uncover<3->{My eventual goal is the query system I've described elsewhere; I see these as prerequisite pieces that are usable even without analysis-as-a-service.}
\end{frame}
